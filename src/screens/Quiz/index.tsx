...
import { Alert, ScrollViewProps, Text, View } from 'react-native';
...
export function Quiz() {
  ...
  const scrollHandler = useAnimatedScrollHandler({
    onScroll: (event: ScrollViewProps) => {
  ...
  const headerStyles = useAnimatedStyle(() => {
    return {
      opacity: interpolate(scrollY.value, [60, 95], [1, 0], Extrapolate.CLAMP),
    }
  })
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Animated.View
          style={[headerStyles, styles.header]}
        >
          <QuizHeader
            title={quiz.title}
